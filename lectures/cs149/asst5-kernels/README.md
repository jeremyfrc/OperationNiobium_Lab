...
## Acknowledgments
This assignment utilizes infrastructure from GPU Mode's [Popcorn-CLI](https://github.com/gpu-mode/popcorn-cli) and [kernelbot](https://github.com/gpu-mode/kernelbot). We are grateful to the GPU Mode community for their open-source contributions.